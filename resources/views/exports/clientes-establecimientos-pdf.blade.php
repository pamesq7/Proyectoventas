...
<head>
    <meta charset="utf-8">
    <title>Lista de Clientes Establecimientos</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Lista de Clientes Establecimientos</h1>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            <strong>Con Email:</strong> {{ $clientes->whereNotNull('email')->count() }}
        </div>
    </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if($cliente->direccion)
                        <br><small style="color: #666;">{{ $cliente->direccion }}</small>
                    @endif
                </td>
    ...
    @else
    <div class="no-data">
        <p>No se encontraron clientes establecimientos con los filtros aplicados.</p>
    </div>
    @endif
