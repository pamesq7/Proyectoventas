...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            <strong>Usuarios Activos:</strong> {{ $usuarios->where('estado', 1)->count() }}
        </div>
        <div class="info-row">
            <strong>Usuarios Inactivos:</strong> {{ $usuarios->where('estado', 0)->count() }}
        </div>
        <div class="info-row">
            <strong>Con Email:</strong> {{ $usuarios->whereNotNull('email')->count() }}
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    @if($usuario->segundApellido)
                        {{ $usuario->segundApellido }}
                    @endif
                </td>
    ...
    <div class="footer">
        ...
        <p>Página 1 de 1 | Total de registros: {{ $total_usuarios }}</p>
    </div>
</body>
</html>
