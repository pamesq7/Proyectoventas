    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('rolOperador.catalogo') }}" class="btn btn-primary btn-sm me-2">
        ...
        <div class="card-body">
                ...
                <table class="table table-striped table-hover" id="pedidosTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('rolOperador.show', $pedido->idVenta) }}"
            ...
            <div class="text-center py-4">
                ...
                <p class="text-muted">Puedes ver el catálogo de productos disponibles</p>
