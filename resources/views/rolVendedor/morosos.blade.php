                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="h5 mb-0">Bs. {{ number_format($clientesMorosos->sum('total_deuda'), 2) }}</div>
                        </div>
                        <div class="fa-2x">
                        ...
                        <tbody>
                            @foreach($clientesMorosos as $cliente)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-warning">{{ $cliente->cantidad_ventas_pendientes }}</span>
                                    </td>
                                    <td>
                                        <strong class="text-danger">
                                            Bs. {{ number_format($cliente->total_deuda, 2) }}
                                        </strong>
                                    </td>
                                    <td>
                                        @if($diasAtraso > 0)
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            @if($cliente->telefono)
                                                <a href="https://wa.me/51{{ $cliente->telefono }}?text=Hola {{ $cliente->nombre_cliente }}, te contactamos por el saldo pendiente de Bs. {{ number_format($cliente->total_deuda, 2) }}" 
                                                   target="_blank" 
